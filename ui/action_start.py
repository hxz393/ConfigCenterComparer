...
class ActionStart:
    ...
    def initialize(self) -> None:
        ...
        logger.debug(f'Func initialize done')
    ...
    def table_column_hide(self, query_statuses: Dict[str, bool]) -> None:
        ...
        logger.debug(f'Func table_insert and table_column_hide done')
...
class StartWork(QThread):
    ...
    def run(self) -> None:
        ...
        try:
            ...
            logger.debug(f'Func prepare_table_rows done')
            if not table_rows:
            ...
            # 收尾工作
            self.finalize_signal.emit(self.config_main.get('color_set', 'ON'))
